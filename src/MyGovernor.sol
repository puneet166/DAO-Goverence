...
// File: contracts/src/MyGovernor.sol
 ...
 * Notes:
 *     - Governor:
 *     Core of the system. Keeps a mapping of proposals and their states.
 *     state function returns the state of a proposal.
 *     GovernorVote => used for ERC20 voting.
 *     - TimelockController:
 *     Adds a delay to operations. Used to queue and execute operations. (allows people to leave the system if they disagree with a proposal).
 *     Proposals are operated through the timelock (not Governor). Assets & permissions should be attached to the timelock.
 */
